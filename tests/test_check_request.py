...
@pytest.mark.parametrize("value", ["0", "-1", "501", "100.5", "many"])
...
async def test_collect_requested_posts_passes_100_message_limit_to_parser():
    class FakeParser:
    ...
    request = parse_check_request("/check @channel")
